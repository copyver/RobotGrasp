...
/// @param  [in]  min_distance          The min distance(mm), which is generally set to the minimum measured distance of the current m_camera
/// @param  [in]  max_distance          The longest distance(mm), which is generally set to the longest measuring distance of the current m_camera
