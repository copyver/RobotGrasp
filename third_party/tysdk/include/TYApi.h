/**@file      TYApi.h
 * @brief     TYApi.h includes m_camera control and data receiving interface,
...
*
* @section Note
*   Depth m_camera, called "device", consists of several components. Each component
...
typedef enum TY_DEVICE_COMPONENT_LIST :uint32_t
{
    ...
    TY_COMPONENT_DEPTH_CAM      = 0x00010000, ///< Depth m_camera
    TY_COMPONENT_IR_CAM_LEFT    = 0x00040000, ///< Left IR m_camera
    TY_COMPONENT_IR_CAM_RIGHT   = 0x00080000, ///< Right IR m_camera
    TY_COMPONENT_RGB_CAM_LEFT   = 0x00100000, ///< Left RGB m_camera
    TY_COMPONENT_RGB_CAM_RIGHT  = 0x00200000, ///< Right RGB m_camera
    ...
    TY_COMPONENT_RGB_CAM        = TY_COMPONENT_RGB_CAM_LEFT ///< Some device has only one RGB m_camera, map it to left
...
typedef enum TY_FEATURE_ID_LIST :uint32_t
{
    ...
    TY_STRUCT_IMU_CAM_TO_IMU        = 0x0607 | TY_FEATURE_STRUCT, ///< IMU m_camera to imu matrix, see TY_CAMERA_TO_IMU
...
///m_camera distortion parameters
/// @see TYGetStruct
/// Usage:
///@code
